...
import { AlertCircle, CheckCircle2, ChevronRight, CircleDollarSign, Package, PackageCheck, Plus, Search, ShoppingCart, SlidersHorizontal } from "lucide-react"
...
const approvals: SupplyApprovalStatus[] = ["Not Required", "Awaiting Approval", "Approved", "Declined"]
const statuses: SupplyStatus[] = ["Submitted", "Ready to Order", "Ordered", "Received", "Cancelled"]
...
export default function SupplyRequestsPage() {
  const { supplyRequests, locations } = useApp()
